               ...
               <div className="max-w-4xl mx-auto text-center relative z-10">
                  ...
                  <div className="mt-16 flex flex-wrap justify-center gap-12 md:gap-24 border-t border-bg-main/5 pt-12">
                     {profile.stats.map((stat, index) => (
                        ...
                        >
                           <div className="text-5xl font-black text-emerald-modern tracking-tighter">{stat.value}</div>
                           <div className="text-[10px] font-bold tracking-widest opacity-40 uppercase mt-2">{stat.label}</div>
                        </motion.div>
                     ))}
                  </div>
               </div>
